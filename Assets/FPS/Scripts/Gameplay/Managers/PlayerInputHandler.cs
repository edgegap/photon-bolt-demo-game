...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        void OnLocalPlayerReady(GameObject player)
        {
            ...
            if (m_PlayerCharacterController != null && m_PlayerCharacterController.IsLocalPlayer && !HeadlessServerManager.IsHeadlessMode())
            {
        ...
        void LateUpdate()
        {
            ...
            if (!m_PlayerCharacterController.IsLocalPlayer) return;
        ...
        {
            if (m_PlayerCharacterController == null || m_GameFlowManager == null) return false;
            else if (!m_PlayerCharacterController.IsLocalPlayer) return false;
            else return Cursor.lockState == CursorLockMode.Locked && !m_GameFlowManager.GameIsEnding;
        }
