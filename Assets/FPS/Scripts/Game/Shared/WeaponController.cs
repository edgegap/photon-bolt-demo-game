...
namespace Unity.FPS.Game
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        public void ShowWeapon(bool show)
        {
            ...
            if (show && ChangeWeaponSfx && m_ShootAudioSource != null)
            {
        ...
        void HandleShoot()
        {
            ...
            for (int i = 0; i < bulletsPerShotFinal; i++)
            {
                ...
                // Create projectile event for server
                CreateProjectileEvent projectileEvent = CreateProjectileEvent.Create();
                projectileEvent.OwnerEntity = GetComponentInParent<BoltEntity>();
                projectileEvent.ProjectilePrefab = ProjectilePrefab.entity.PrefabId;
                projectileEvent.MuzzlePosition = WeaponMuzzle.position;
                projectileEvent.ShotDirection = shotDirection;
                projectileEvent.Send();
